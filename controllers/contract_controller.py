...
class ContractController:
    ...
    def menu_customer(self, employee_id):
        ...
        while True:
            ...
            if choice == MENU_CONTRACT_CREATION:
                ...
                permission = self.contract_model.check_permission_filter_menu(employee_id)
                if permission:
                    while True:
    ...
    def sign_contract(self, employee_id):
        ...
        if not_signed_contracts_list:
            ...
            display_message("Aucun contrat non signés dans la base de donnée. Retour au menu...", True, True, 3)
    ...
    def filter_contract_by_signature(self):
        ...
        if contracts_obj_list:
            ...
            display_message("Tous les contrats sont signés. Retour au menu...", True, True, 3)
    ...
    def filter_contract_by_payed(self):
        ...
        if contracts_obj_list:
            ...
            display_message("Tous les contrats sont payés. Retour au menu...", True, True, 3)
